...
-- Volcando estructura de base de datos para hr
DROP DATABASE IF EXISTS `hr`;
CREATE DATABASE IF NOT EXISTS `hr` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `hr`;

-- Volcando estructura para tabla hr.countries
...
-- Volcando datos para la tabla hr.countries: ~25 rows (aproximadamente)
...
-- Volcando estructura para tabla hr.departments
...
-- Volcando datos para la tabla hr.departments: ~27 rows (aproximadamente)
...
-- Volcando estructura para tabla hr.employees
...
-- Volcando datos para la tabla hr.employees: ~107 rows (aproximadamente)
...
-- Volcando estructura para vista hr.emp_details_view
...
-- Volcando estructura para tabla hr.jobs
...
-- Volcando datos para la tabla hr.jobs: ~19 rows (aproximadamente)
...
-- Volcando estructura para tabla hr.job_history
...
-- Volcando datos para la tabla hr.job_history: ~10 rows (aproximadamente)
...
-- Volcando estructura para tabla hr.locations
...
-- Volcando datos para la tabla hr.locations: ~23 rows (aproximadamente)
...
-- Volcando estructura para tabla hr.regions
...
-- Volcando datos para la tabla hr.regions: ~4 rows (aproximadamente)
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `emp_details_view` AS SELECT e.employee_id,
	e.job_id,
	e.manager_id,
	e.department_id,
	d.location_id,
